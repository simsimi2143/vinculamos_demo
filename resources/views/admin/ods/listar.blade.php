                ...
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="col-12">
                            <a class="btn">
                                <img alt="image" src="{{ asset('public/img/ods/1.png') }}" width="150">
                            </a>
                            <a class="btn">
                                <img alt="image" src="{{ asset('public/img/ods/2.png') }}" width="150">
                            </a>
                            <a class="btn">
                                <img alt="image" src="{{ asset('public/img/ods/3.png') }}" width="150">
                            </a>
                            <a class="btn">
                                <img alt="image" src="{{ asset('public/img/ods/4.png') }}" width="150">
                            </a>
                            <a class="btn">
                                <img alt="image" src="{{ asset('public/img/ods/5.png') }}" width="150">
                            </a>
                            <a class="btn">
                                <img alt="image" src="{{ asset('public/img/ods/6.png') }}" width="150">
                            </a>
                            <a class="btn">
                                <img alt="image" src="{{ asset('public/img/ods/7.png') }}" width="150">
                            </a>
                            <a class="btn">
                                <img alt="image" src="{{ asset('public/img/ods/8.png') }}" width="150">
                            </a>
                            <a class="btn">
                                <img alt="image" src="{{ asset('public/img/ods/9.png') }}" width="150">
                            </a>
                            <a class="btn">
                                <img alt="image" src="{{ asset('public/img/ods/10.png') }}" width="150">
                            </a>
                            <a class="btn">
                                <img alt="image" src="{{ asset('public/img/ods/11.png') }}" width="150">
                            </a>
                            <a class="btn">
                                <img alt="image" src="{{ asset('public/img/ods/12.png') }}" width="150">
                            </a>
                            <a class="btn">
                                <img alt="image" src="{{ asset('public/img/ods/13.png') }}" width="150">
                            </a>
                            <a class="btn">
                                <img alt="image" src="{{ asset('public/img/ods/14.png') }}" width="150">
                            </a>
                            <a class="btn">
                                <img alt="image" src="{{ asset('public/img/ods/15.png') }}" width="150">
                            </a>
                            <a class="btn">
                                <img alt="image" src="{{ asset('public/img/ods/16.png') }}" width="150">
                            </a>
                            <a class="btn">
                                <img alt="image" src="{{ asset('public/img/ods/17.png') }}" width="150">
                            </a>
                            <a class="btn">
                                <img alt="image" src="{{ asset('public/img/ods/0.jpg') }}" width="150">
                            </a>
                            </div>
                                ...
                                <table class="table table-striped" id="table-1">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>
                                                <a class="btn">
                                                    <img alt="image" src="{{ asset('public/img/ods/1.png') }}" width="60">
                                                </a>
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td>
                                                <a class="btn">
                                                    <img alt="image" src="{{ asset('public/img/ods/2.png') }}" width="60">
                                                </a>
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td>
                                                <a class="btn">
                                                    <img alt="image" src="{{ asset('public/img/ods/3.png') }}" width="60">
                                                </a>
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td>
                                                <a class="btn">
                                                    <img alt="image" src="{{ asset('public/img/ods/4.png') }}" width="60">
                                                </a>
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td>
                                                <a class="btn">
                                                    <img alt="image" src="{{ asset('public/img/ods/5.png') }}" width="60">
                                                </a>
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td>
                                                <a class="btn">
                                                    <img alt="image" src="{{ asset('public/img/ods/6.png') }}" width="60">
                                                </a>
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td>
                                                <a class="btn">
                                                    <img alt="image" src="{{ asset('public/img/ods/7.png') }}" width="60">
                                                </a>
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td>
                                                <a class="btn">
                                                    <img alt="image" src="{{ asset('public/img/ods/8.png') }}" width="60">
                                                </a>
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td>
                                                <a class="btn">
                                                    <img alt="image" src="{{ asset('public/img/ods/9.png') }}" width="60">
                                                </a>
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td>
                                                <a class="btn">
                                                    <img alt="image" src="{{ asset('public/img/ods/10.png') }}" width="60">
                                                </a>
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td>
                                                <a class="btn">
                                                    <img alt="image" src="{{ asset('public/img/ods/11.png') }}" width="60">
                                                </a>
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td>
                                                <a class="btn">
                                                    <img alt="image" src="{{ asset('public/img/ods/12.png') }}" width="60">
                                                </a>
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td>
                                                <a class="btn">
                                                    <img alt="image" src="{{ asset('public/img/ods/13.png') }}" width="60">
                                                </a>
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td>
                                                <a class="btn">
                                                    <img alt="image" src="{{ asset('public/img/ods/14.png') }}" width="60">
                                                </a>
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td>
                                                <a class="btn">
                                                    <img alt="image" src="{{ asset('public/img/ods/15.png') }}" width="60">
                                                </a>
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td>
                                                <a class="btn">
                                                    <img alt="image" src="{{ asset('public/img/ods/16.png') }}" width="60">
                                                </a>
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td>
                                                <a class="btn">
                                                    <img alt="image" src="{{ asset('public/img/ods/17.png') }}" width="60">
                                                </a>
                                            </td>
                                        </tr>
                                    </tbody>
