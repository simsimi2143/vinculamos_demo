...
<body
    style="background: url({{ asset('public/img/Imagen-auth.jpg') }});background-size:cover; background-repeat:repeat;background-attachment: fixed;background-position: center;">
